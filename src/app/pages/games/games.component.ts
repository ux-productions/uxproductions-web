...
export class GamesComponent {
  ...
  protected readonly games: Game[] = [
    ...
    },
    {
      ...
      image: 'images/game-the-perfect-murder.jpg',
    ...
    {
      id: 'the-perfect-race',
      titleSv: 'The Perfect Race',
      titleEn: 'The Perfect Race',
      descriptionSv: 'The Perfect Race är ett fartfyllt arkadracingspel uppifrån med sladdvänlig körkänsla inspirerad av tidiga 90-talsspel. Sätt din bästa tid, tävla mot verifierade spökvarv och klättra på säsongens topplistor — eller möt andra förare i livespel. Spela direkt i webbläsaren.',
      descriptionEn: 'The Perfect Race is a momentum-based top-down arcade racer with drift-happy handling inspired by early-90s games. Set your best time, race verified ghost laps and climb the seasonal leaderboards — or face other drivers in live multiplayer. Play right in your browser.',
